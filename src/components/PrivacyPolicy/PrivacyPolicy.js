...
const PrivacyPolicy = () => {
    return (
        <div className='privacy-policy'>
            ...
            <h1 className="pph1">Privacy Policy</h1>
            <p className='ppp'>
            ...
            <p className='ppp'>
                <h2 className='pph2'>Information We Collect</h2>
                <p className='ppp'>
                        1. Name;<br/>
                ...
                <h2 className='pph2'>How we Use Your Information</h2>

                <p className='ppp'>We generally use your information to:
                <br></br>
                ...
                <h2 className='pph2'>How we Disclose Your Information</h2>



                <p className='ppp'>We may share your information as follows:
                <br></br>
                ...
                <h2 className='pph2'>Security</h2>
                <p className='ppp'>DeViine takes commercially reasonable steps to help protect your Information against loss, misuse and unauthorized access, or disclosure. No company can fully prevent security risks, however. While we strive to protect your personal information, we cannot guarantee its absolute security. To help protect yourself and your information, choose a unique password for our Services and do not use a password on our Services that you would use on any other website or online service.</p>
                <h2 className='pph2'>Dispute Resolution</h2>
                <p className='ppp'>If you believe that DeViine has not adhered to this Statement, please contact DeViine by e-mail at support@deviine.com. We will do our best to address your concerns. If you feel that your complaint has been addressed incompletely, we invite you to let us know for further investigation.</p>
                <h2 className='pph2'>Information Choices</h2>
                <p className='ppp'>You may opt out of receiving promotional emails from DeViine by following the instructions in those emails. If you opt out, we may still send you non-promotional emails, such as emails about your accounts or our ongoing business relations. You may also send requests about your personal information, including changes to your contact preferences, changes to or deletions of your information or content you post, and requests to opt-out of sharing your personal information with third parties by emailing support@deviine.com. Please note that deletion of your information or content does not ensure complete or comprehensive removal of the content or information posted on the Services.
                <br></br>
                ...
                <br></br>
                You may have the right to know what personal information DeViine has about you and to correct any inaccuracies. Please direct any such requests by email to support@deviine.com or by one of the other means listed below.
                </p>
                <h2 className='pph2'>Changes and Updates to this Privacy Policy</h2>
                <p className='ppp'>From time to time, we may revise the Policy. To help you stay current of any changes, we note the date the Privacy Policy was last updated above.</p>
                <h2 className='pph2'>Contact Information</h2>

                <p className='ppp'>Please contact DeViine with any questions or comments about this Policy, your information, our third-party disclosure practices, or your consent choices.
                <br></br>
                DeViine LLC <br></br>
                28 W. 3rd Avenue, Suite B-1 <br></br>
                Spokane, WA 99201
                <br></br>
